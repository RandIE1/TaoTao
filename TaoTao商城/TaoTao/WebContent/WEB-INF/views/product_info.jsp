				...
				<div class="col-md-6">
					...
					<div
						...
						<div
							...
							购买数量: 
							<input id="quantity" name="buyNum" value="1" maxlength="4" size="10" type="text">
						</div>
					...
					<div>
						<a href="${pageContext.request.contextPath}/product?cid=${cid}&currentPage=${currentPage}">返回商品列表</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
