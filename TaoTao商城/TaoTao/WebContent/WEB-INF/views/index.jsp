	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<c:forEach items="${hostProduct }" var="hostpro">
					<div class="col-md-2"
						style="text-align: center; height: 200px; padding: 10px 0px;">
						<a href="${pageContext.request.contextPath}/productInfo?pid=${hostpro.pid }">
							<img src="${hostpro.pimage} " width="130" height="130"style="display: inline-block;">
						</a>
						<p>
							<a href="product_info.html" style='color: #666'>${hostpro.pname }</a>
						</p>
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${hostpro.shop_price }</font>
						</p>
					</div>
				</c:forEach>
